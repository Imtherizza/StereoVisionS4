...
int snaps (bool skip)
{
       ...
       // VideoCapture capR(0),capL(2);
        VideoCapture capR(4),capL(5);//ZED

        capR.set(CAP_PROP_FRAME_HEIGHT, 320);
        capR.set(CAP_PROP_FRAME_WIDTH, 240);
        //capR.set(CAP_PROP_FPS, 60);
        capL.set(CAP_PROP_FRAME_HEIGHT, 320);
        capL.set(CAP_PROP_FRAME_WIDTH, 240);
        //capL.set(CAP_PROP_FPS, 60);
        ...
        int count = 1;
        FileStorage fs;
        string filename = "/home/stereo-2022/StereoVision/stereo_pics/data/"+fichier_xml;
        string r,l;
        string chemin_dossier_calib = "/home/stereo-2022/StereoVision/stereo_pics/data";
        string chemin_dossier_img = "/home/stereo-2022/StereoVision/stereo_pics/data/Image"; //a definir
        Mat frameR,frameL;
...
{
    string chemin_intrinsics = "/home/stereo-2022/StereoVision/stereo_pics/data/";
    string chemin_extrinsics = "/home/stereo-2022/StereoVision/stereo_pics/data/";
...
int stereo_match(int argc, char** argv)
{
    ...
    int alg = STEREO_SGBM;
    int 
    SADWindowSize = 0, numberOfDisparities = 0;
    ...
    Mat img1 = imread(im1_namae, color_mode);//////////////////
    Mat img2 = imread(im2_namae, color_mode);/////////////////
