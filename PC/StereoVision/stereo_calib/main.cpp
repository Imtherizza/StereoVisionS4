//from https://learnopencv.com/making-a-low-cost-stereo-camera-using-opencv/
...
int CHECKERBOARD[2]{5,8}; //lignes,colonnes comper les inter
...
std::string pathL = "../data/calib_image_droite/*.jpg";
std::string pathR = "../data/calib_image_gauche/*.jpg";
...
cv::FileStorage cv_file = cv::FileStorage("../../disparity_ajust/data/improved_params2_cpp.xml", cv::FileStorage::WRITE);
