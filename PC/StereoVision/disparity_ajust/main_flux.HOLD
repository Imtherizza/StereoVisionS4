//from https://github.com/spmallick/learnopencv/tree/master/stereo-camera
...
int main()
{
  ...
  cv::FileStorage cv_file2 = cv::FileStorage("../data/improved_params2_cpp.xml", cv::FileStorage::READ);
  ...
  cv::resizeWindow("disparity",320,240);
  ...
  while (true)
  {
   // imgL = cv::imread("../data/Image/right.jpg");// path to left image is "../im0.png"
    //imgR = cv::imread("../data/Image/left.jpg");
